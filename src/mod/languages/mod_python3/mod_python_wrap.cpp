...
SWIGINTERN PyObject *_wrap_DTMF_duration_set(PyObject *self, PyObject *args) {
  ...
  arg1 = reinterpret_cast< DTMF * >(argp1);
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "DTMF_duration_set" "', argument " "2"" of type '" "uint32_t""'");
    } else {
...
SWIGINTERN PyObject *_wrap_new_DTMF(PyObject *self, PyObject *args) {
  ...
  if (swig_obj[1]) {
    {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_DTMF" "', argument " "2"" of type '" "uint32_t""'");
      } else {
        uint32_t * temp = reinterpret_cast< uint32_t * >(argp2);
        arg2 = *temp;
        if (SWIG_IsNewObj(res2)) delete temp;
  ...
  result = (DTMF *)new DTMF(arg1,SWIG_STD_MOVE(arg2));
...
SWIGINTERN PyObject *_wrap_Event_setPriority(PyObject *self, PyObject *args) {
  ...
  if (swig_obj[1]) {
    {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Event_setPriority" "', argument " "2"" of type '" "switch_priority_t""'");
      } else {
  ...
  result = (bool)(arg1)->setPriority(SWIG_STD_MOVE(arg2));
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_EventConsumer_e_event_id_set(PyObject *self, PyObject *args) {
  ...
  arg1 = reinterpret_cast< EventConsumer * >(argp1);
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EventConsumer_e_event_id_set" "', argument " "2"" of type '" "switch_event_types_t""'");
    } else {
...
SWIGINTERN PyObject *_wrap_EventConsumer_enodes_set(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  EventConsumer *arg1 = (EventConsumer *) 0 ;
  switch_event_node_t **arg2 = (switch_event_node_t **) (switch_event_node_t **)0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  arg2 = reinterpret_cast< switch_event_node_t ** >(argp2);
  {
    if (arg2) {
      ...
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""enodes""' of type '""switch_event_node_t *[SWITCH_EVENT_ALL+1]""'");
    }
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_EventConsumer_node_index_set(PyObject *self, PyObject *args) {
  ...
  arg1 = reinterpret_cast< EventConsumer * >(argp1);
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EventConsumer_node_index_set" "', argument " "2"" of type '" "uint32_t""'");
    } else {
      uint32_t * temp = reinterpret_cast< uint32_t * >(argp2);
      arg2 = *temp;
      if (SWIG_IsNewObj(res2)) delete temp;
...
SWIGINTERN PyObject *_wrap_CoreSession_hook_state_set(PyObject *self, PyObject *args) {
  ...
  arg1 = reinterpret_cast< CoreSession * >(argp1);
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "CoreSession_hook_state_set" "', argument " "2"" of type '" "switch_channel_state_t""'");
    } else {
...
SWIGINTERN PyObject *_wrap_CoreSession_cause_set(PyObject *self, PyObject *args) {
  ...
  arg1 = reinterpret_cast< CoreSession * >(argp1);
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "CoreSession_cause_set" "', argument " "2"" of type '" "switch_call_cause_t""'");
    } else {
...
SWIGINTERN PyObject *_wrap_CoreSession_run_dtmf_callback(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (!argp3) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "CoreSession_run_dtmf_callback" "', argument " "3"" of type '" "switch_input_type_t""'");
    } else {
  ...
  result = (arg1)->run_dtmf_callback(arg2,SWIG_STD_MOVE(arg3));
  resultobj = SWIG_NewPointerObj((new switch_status_t(result)), SWIGTYPE_p_switch_status_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_bridge(PyObject *self, PyObject *args) {
  ...
  if (!argp1) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "bridge" "', argument " "1"" of type '" "CoreSession &""'"); 
  }
  arg1 = reinterpret_cast< CoreSession * >(argp1);
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "bridge" "', argument " "2"" of type '" "CoreSession &""'"); 
  }
  arg2 = reinterpret_cast< CoreSession * >(argp2);
  bridge(*arg1,*arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_dtmf_callback(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (!argp3) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "dtmf_callback" "', argument " "3"" of type '" "switch_input_type_t""'");
    } else {
      switch_input_type_t * temp = reinterpret_cast< switch_input_type_t * >(argp3);
      arg3 = *temp;
      if (SWIG_IsNewObj(res3)) delete temp;
...
SWIGINTERN PyObject *_wrap_Session_run_dtmf_callback(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (!argp3) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Session_run_dtmf_callback" "', argument " "3"" of type '" "switch_input_type_t""'");
    } else {
      switch_input_type_t * temp = reinterpret_cast< switch_input_type_t * >(argp3);
      arg3 = *temp;
      if (SWIG_IsNewObj(res3)) delete temp;
